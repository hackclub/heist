...
module Safely
  ...
  class << self
    # pkg:gem/safely_block#lib/safely/core.rb:29
    def env; end
    ...
    #
    # pkg:gem/safely_block#lib/safely/core.rb:11
    def env=(_arg0); end
    ...
    # pkg:gem/safely_block#lib/safely/core.rb:13
    ...
    # @return [Boolean]
    #
    # pkg:gem/safely_block#lib/safely/core.rb:33
