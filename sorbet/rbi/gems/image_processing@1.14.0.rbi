...
module ImageProcessing::Chainable
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/chainable.rb:64
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/chainable.rb:55
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/chainable.rb:49
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/chainable.rb:86
...
# pkg:gem/image_processing#lib/image_processing/mini_magick.rb:5
module ImageProcessing::MiniMagick
  extend ::ImageProcessing::Chainable

  class << self
    # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:8
...
# pkg:gem/image_processing#lib/image_processing/mini_magick.rb:27
class ImageProcessing::MiniMagick::Processor < ::ImageProcessing::Processor
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:167
  def append(*args); end
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:104
  def crop(*args); end

  # Defines settings from the provided hash.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:155
  def define(options); end

  # Specifies resource limits from the provided hash.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:161
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:90
  ...
  # cropping the excess.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:99
  def resize_to_cover(width, height, **options); end

  # Resizes the image to fill the specified dimensions, applying any
  # necessary cropping.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:81
  def resize_to_fill(width, height, gravity: T.unsafe(nil), **options); end

  # Resizes the image to fit within the specified dimensions.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:75
  def resize_to_fit(width, height, **options); end

  # Resizes the image to not be larger than the specified dimensions.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:70
  ...
  # fill in the gaps.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:115
  def rotate(degrees, background: T.unsafe(nil)); end

  protected

  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:28
  def magick; end
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:203
  def convert_to_path(file, name); end

  # Resizes the image using the specified geometry, and sharpens the
  # resulting thumbnail.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:191
  ...
  class << self
    ...
    #
    # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:36
    ...
    # image (e.g. quality).
    #
    # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:60
...
# pkg:gem/image_processing#lib/image_processing/mini_magick.rb:215
module ImageProcessing::MiniMagick::Processor::Utils
  private

  # Applies settings from the provided (nested) hash.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:244
  def apply_define(magick, options); end

  # Applies options from the provided hash.
  #
  # pkg:gem/image_processing#lib/image_processing/mini_magick.rb:231
...
# pkg:gem/image_processing#lib/image_processing/vips.rb:7
...
class ImageProcessing::Vips::Processor < ::ImageProcessing::Processor
  ...
  # cropping the excess.
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:95
  def resize_to_cover(width, height, **options); end

  # Resizes the image to fill the specified dimensions, applying any
  # necessary cropping.
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:81
  def resize_to_fill(width, height, **options); end

  # Resizes the image to fit within the specified dimensions.
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:74
  def resize_to_fit(width, height, **options); end

  # Resizes the image to not be larger than the specified dimensions.
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:68
  def resize_to_limit(width, height, **options); end
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:149
  def set(*args); end

  # pkg:gem/image_processing#lib/image_processing/vips.rb:150
  def set_type(*args); end

  # pkg:gem/image_processing#lib/image_processing/vips.rb:151
  def set_value(*args); end

  protected

  # pkg:gem/image_processing#lib/image_processing/vips.rb:19
  def image; end
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:182
  ...
  # @raise [Error]
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:175
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:158
  ...
  class << self
    ...
    # image to be upright.
    #
    # pkg:gem/image_processing#lib/image_processing/vips.rb:30
    ...
    #
    # pkg:gem/image_processing#lib/image_processing/vips.rb:56
    ...
    # @return [Boolean]
    #
    # pkg:gem/image_processing#lib/image_processing/vips.rb:49
    def supports_resize_on_load?; end
  end
end
...
# pkg:gem/image_processing#lib/image_processing/vips.rb:198
module ImageProcessing::Vips::Processor::Utils
  ...
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:219
  def select_valid_options(operation_name, options); end

  # Filters out unknown options for saving images.
  #
  # pkg:gem/image_processing#lib/image_processing/vips.rb:208
