...
# versioning.
#
# pkg:gem/paper_trail#lib/paper_trail/errors.rb:3
module PaperTrail
  ...
  class << self
    ...
    # @yield [@config]
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:106
    def config; end
    ...
    # @yield [@config]
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:111
    def configure; end

    # pkg:gem/paper_trail#lib/paper_trail.rb:118
    def deprecator; end
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:40
    ...
    # @return [Boolean]
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:47
    def enabled?; end
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:57
    def gem_version; end
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:77
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:99
    def serializer; end
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:93
    ...
    # @raise [Error]
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:87
    def timestamp_field=(_field_name); end

    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail.rb:114
    def version; end
  end
end
...
#
# pkg:gem/paper_trail#lib/paper_trail/cleaner.rb:5
module PaperTrail::Cleaner
  ...
  #
  # pkg:gem/paper_trail#lib/paper_trail/cleaner.rb:20
  ...
  # chronological order.
  #
  # pkg:gem/paper_trail#lib/paper_trail/cleaner.rb:39
  ...
  # @api private
  #
  # pkg:gem/paper_trail#lib/paper_trail/cleaner.rb:56
...
# versions.
#
# pkg:gem/paper_trail#lib/paper_trail/compatibility.rb:19
module PaperTrail::Compatibility
  class << self
    ...
    # @raise [::TypeError]
    #
    # pkg:gem/paper_trail#lib/paper_trail/compatibility.rb:35
...
class PaperTrail::Config
  ...
  #
  # pkg:gem/paper_trail#lib/paper_trail/config.rb:21
  def initialize; end

  # Returns the value of attribute association_reify_error_behaviour.
  #
  # pkg:gem/paper_trail#lib/paper_trail/config.rb:12
  ...
  #
  # pkg:gem/paper_trail#lib/paper_trail/config.rb:33
  def enabled; end

  # pkg:gem/paper_trail#lib/paper_trail/config.rb:37
  ...
  class << self
    ...
    # pkg:gem/paper_trail#lib/paper_trail/config.rb:10
    def allocate; end
...
# pkg:gem/paper_trail#lib/paper_trail.rb:29
...
# @api public
#
# pkg:gem/paper_trail#lib/paper_trail/errors.rb:6
...
# @api public
#
# pkg:gem/paper_trail#lib/paper_trail/errors.rb:11
...
# @api private
#
# pkg:gem/paper_trail#lib/paper_trail/frameworks/rails/railtie.rb:7
...
# @api private
#
# pkg:gem/paper_trail#lib/paper_trail/record_history.rb:6
class PaperTrail::RecordHistory
  ...
  #
  # pkg:gem/paper_trail#lib/paper_trail/record_history.rb:11
  ...
  # @api private
  #
  # pkg:gem/paper_trail#lib/paper_trail/record_history.rb:18
  ...
  #
  # pkg:gem/paper_trail#lib/paper_trail/record_history.rb:40
  def primary_key; end
  ...
  # @api private
  #
  # pkg:gem/paper_trail#lib/paper_trail/record_history.rb:26
  def sequence; end
  ...
  #   not always.
  #
  # pkg:gem/paper_trail#lib/paper_trail/record_history.rb:47
  def table; end
end
...
# @api private
#
# pkg:gem/paper_trail#lib/paper_trail/request.rb:14
module PaperTrail::Request
  class << self
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:34
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:23
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:40
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:46
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:52
    def enabled=(value); end
    ...
    # @return [Boolean]
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:59
    def enabled?; end
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:66
    ...
    # @return [Boolean]
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:73
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:107
    def whodunnit; end
    ...
    # @api public
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:100
    ...
    # @api private
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:80
    ...
    # @api private
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:115
    def merge(options); end

    # @api private
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:122
    def set(options); end
    ...
    # @api private
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:129
    def store; end
    ...
    # @api private
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:140
    def to_h; end
    ...
    # @api private
    #
    # pkg:gem/paper_trail#lib/paper_trail/request.rb:148
    def validate_public_options(options); end
  end
end

# pkg:gem/paper_trail#lib/paper_trail/serializers/yaml.rb:6
module PaperTrail::Serializers; end

# An alternate serializer for, e.g. `versions.object`.
#
# pkg:gem/paper_trail#lib/paper_trail/serializers/json.rb:6
module PaperTrail::Serializers::JSON
  extend ::PaperTrail::Serializers::JSON

  # pkg:gem/paper_trail#lib/paper_trail/serializers/json.rb:13
  def dump(object); end

  # pkg:gem/paper_trail#lib/paper_trail/serializers/json.rb:9
  def load(string); end

  # Returns a SQL LIKE condition to be used to match the given field and
  # value in the serialized object.
  #
  # pkg:gem/paper_trail#lib/paper_trail/serializers/json.rb:19
  def where_object_condition(arel_field, field, value); end
end

# The default serializer for, e.g. `versions.object`.
#
# pkg:gem/paper_trail#lib/paper_trail/serializers/yaml.rb:8
module PaperTrail::Serializers::YAML
  ...
  #
  # pkg:gem/paper_trail#lib/paper_trail/serializers/yaml.rb:29
  def dump(object); end

  # pkg:gem/paper_trail#lib/paper_trail/serializers/yaml.rb:11
  def load(string); end

  # Returns a SQL LIKE condition to be used to match the given field and
  # value in the serialized object.
  #
  # pkg:gem/paper_trail#lib/paper_trail/serializers/yaml.rb:36
  def where_object_condition(arel_field, field, value); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/paper_trail#lib/paper_trail/serializers/yaml.rb:42
  def use_safe_load?; end

  # pkg:gem/paper_trail#lib/paper_trail/serializers/yaml.rb:55
...
# @api public
#
# pkg:gem/paper_trail#lib/paper_trail/errors.rb:21
class PaperTrail::UnsupportedColumnType < ::PaperTrail::UnsupportedSchema
  ...
  #
  # pkg:gem/paper_trail#lib/paper_trail/errors.rb:22
...
# @api public
#
# pkg:gem/paper_trail#lib/paper_trail/errors.rb:16
...
#
# pkg:gem/paper_trail#lib/paper_trail/version_number.rb:9
module PaperTrail::VERSION
  class << self
    # pkg:gem/paper_trail#lib/paper_trail/version_number.rb:19
    def to_s; end
  end
end

# pkg:gem/paper_trail#lib/paper_trail/version_number.rb:10
PaperTrail::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/paper_trail#lib/paper_trail/version_number.rb:11
PaperTrail::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# Set PRE to nil unless it's a pre-release (beta, rc, etc.)
#
# pkg:gem/paper_trail#lib/paper_trail/version_number.rb:15
PaperTrail::VERSION::PRE = T.let(T.unsafe(nil), T.untyped)

# pkg:gem/paper_trail#lib/paper_trail/version_number.rb:17
PaperTrail::VERSION::STRING = T.let(T.unsafe(nil), String)

# pkg:gem/paper_trail#lib/paper_trail/version_number.rb:12
