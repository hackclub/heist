...
class ActiveSupport::TestCase
  ...
  sig { params(fixture_name: NilClass, other_fixtures: NilClass).returns(T::Array[Ship]) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: NilClass).returns(Ship) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: T.any(String, Symbol)).returns(T::Array[Ship]) }
  def ships(fixture_name = nil, *other_fixtures); end
